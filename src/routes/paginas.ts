...
const CARREGADORES = {
  ...
  '/professor':        () => import('../pages/AreaDoProfessor'),
...
export const DayUses          = lazyWithRetry(CARREGADORES['/day-uses'])
...
export const AreaDoProfessor  = lazyWithRetry(CARREGADORES['/professor'])
