...
export const Voltar = styled.button`border:0;background:none;color:${({theme})=>theme.colors.textSecondary};display:flex;gap:8px;align-items:center;margin-bottom:16px;cursor:pointer;min-height:${ALVO_DE_PONTEIRO};${ate.tablet}{min-height:${ALVO_DE_TOQUE};margin-bottom:8px;}`
